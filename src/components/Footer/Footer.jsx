...
export function Footer() {
  return (
    <footer className="bg-white py-4 font-bold text-xl gap-5 shadow-[0px_0px_16px_0px_#95A1FF33] mx-auto rounded-b-[20px] w-full rounded-t-[20px] shadow-[0px_0px_16px_0px_#95A1FF33]">
